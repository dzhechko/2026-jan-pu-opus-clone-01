import { PLATFORM_LABELS, formatNumber, truncateText, formatDateShort, isSafeUrl } from './format-utils';
              ...
              <tr key={clip.publicationId} className="border-b last:border-b-0 hover:bg-gray-50">
                ...
                <td className="px-4 py-3 font-medium max-w-[200px]">
                  {isSafeUrl(clip.platformUrl) ? (
                    ...
                    >
                      {truncateText(clip.clipTitle)}
                    </a>
                  ) : (
                    <span title={clip.clipTitle}>{truncateText(clip.clipTitle)}</span>
                  )}
                </td>
