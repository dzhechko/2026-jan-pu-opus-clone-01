...
| INS-027 | `verbose_json`, `timeout`, `Connection error`, `STT slow`, `большие чанки` | Cloud.ru STT: маленькие чанки (3 мин) + json формат (без verbose_json) | [INS-027](INS-027-cloudru-stt-chunking.md) | 🟢 Active | 1 |
