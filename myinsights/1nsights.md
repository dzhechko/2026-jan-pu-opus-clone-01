...
| INS-017 | `Unknown field teamId`, `Unknown field processingProgress`, `prisma db push already in sync`, `select` | Prisma Client stale after schema change in monorepo | [INS-017](INS-017-prisma-client-stale-monorepo.md) | 🟢 Active | 3 |
...
| INS-025 | `api.cloud.ru`, `foundation-models.api.cloud.ru`, `CLOUDRU_BASE_URL`, `STT failed`, `Cloud.ru 404` | Cloud.ru base URL mismatch: api.cloud.ru → foundation-models.api.cloud.ru | [INS-025](INS-025-cloudru-base-url.md) | 🟢 Active | 1 |
| INS-026 | `Port 3000 is in use`, `EADDRINUSE`, `using available port 3001`, `next-server zombie` | Port 3000 не освобождается — зомби next-server в Codespace, kill -9 + ss | [INS-026](INS-026-port-3000-zombie-processes.md) | 🟢 Active | 5 |
| INS-027 | `verbose_json`, `timeout`, `Connection error`, `STT slow`, `большие чанки`, `Cloud.ru Codespace` | STT чанкинг: 3мин чанки + json(ru)/verbose_json(global). Cloud.ru недоступен из Codespace | [INS-027](INS-027-cloudru-stt-chunking.md) | 🟢 Active | 2 |
